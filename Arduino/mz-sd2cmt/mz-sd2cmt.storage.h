...
#define ENTRY_UNK       0
#define ENTRY_DIR       1
#define ENTRY_LEP       2 // WAV-like file with 50탎/16탎 resolution where a byte encodes an edge change after a period
...
#define L16_UNIT        16     // LEP resolution in 16탎 unit
#define L50_UNIT        50     // LEP resolution in 50탎 unit
...
struct Storage
{
	...
	unsigned long			lep_unit = L16_UNIT; // 16탎 by default
